...
SELECT
	...
	FROM (SELECT id,
		'ESPAÑOL' idioma_requerido
		FROM "caba-piba-raw-zone-db"."ofertas_laborales_view" WHERE UPPER(idiomas_nombre) LIKE '%ESPAÑOL%'

		UNION

		SELECT id,
		'INGLÉS' idioma_requerido
		FROM "caba-piba-raw-zone-db"."ofertas_laborales_view" WHERE UPPER(idiomas_nombre) LIKE '%INGLÉS%'

		UNION		

		SELECT id,
		'PORTUGUÉS' idioma_requerido
		FROM "caba-piba-raw-zone-db"."ofertas_laborales_view" WHERE UPPER(idiomas_nombre) LIKE '%PORTUGUÉS%'

		UNION		

		SELECT id,
		'ALEMÁN' idioma_requerido
		FROM "caba-piba-raw-zone-db"."ofertas_laborales_view" WHERE UPPER(idiomas_nombre) LIKE '%ALEMÁN%'

		UNION		

		SELECT id,
		'FRANCÉS' idioma_requerido
		FROM "caba-piba-raw-zone-db"."ofertas_laborales_view" WHERE UPPER(idiomas_nombre) LIKE '%FRANCÉS%'
